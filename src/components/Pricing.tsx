...
const plan = {
  ...
  icon: Star,
  description: 'An all-in-one solution for startups, growing businesses, and established brands looking to build, market, and scale their digital presence.',
  features: [
    'Custom Responsive Website (React / Next.js)',
    'Premium UI/UX Design & Interactive Layouts',
    'Mobile & Tablet Optimized Design',
    'Native Android App Development (Kotlin & Java)',
    'Custom Dashboard / Admin Panel',
    'E-commerce Store Development (Shopify)',
    'Secure Payment Gateway Integration',
    'Product & Inventory Management',
    'Booking, Contact & Inquiry Forms',
    ...
    'Advanced SEO Setup & Technical Optimization',
    'Keyword Research & Search Strategy',
    ...
    'Two Months of Priority Support',
  ],
};
