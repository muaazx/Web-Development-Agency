        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold mb-8">
              We are <span className="text-brand">NextGenDevelopers</span>. A collective of designers & builders.
            </h2>
            <p className="text-gray-400 text-lg mb-10 leading-relaxed">
              Founded in 2020, NextGenDevelopers was born from a simple observation: most business websites are either beautiful but broken, or functional but forgettable. We bridge that gap.
            </p>
